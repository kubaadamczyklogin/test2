<!DOCTYPE html>
 <!-- należy ustawić odpowiedni id w href (wiersz 42) na dół oraz w skrypcie (wiersz 57) --> 
<html lang="pl">
  <head>
    <meta charset="utf-8">    
    ...
    <div class="container-fluid" id="cover">
        <div class="row">
            ...
            <div class="col-12 align-self-center">
                ...
                <h2 class="display-5 text-center">front & back end junior&nbsp;developer</h2>
            </div> 
            <!-- strzałka nadół -->
                        ...
                        <div class="modal-header">                            
                          ...
                          <div class="modal-body">
                              <p>Aplikacja ułatwiająca tworzenie opisów do sklepu internetowego.
                                 Słóży głównie do testowania - podglądu jak opis produktu będzie się wyświetlał po wgraniu na serwer sklepu.
                        ...
                        <div class="modal-header">                            
                          ...
                          <div class="modal-body">
                              <p>Strona zapowiadająca projekt Run With Emu - uniwersalny pakiet emulatorów.
                                  Prosta strona informacyjna, zbierająca subskrybcje. Responsywna. Posiada 2 wersje językowe (została zaprojektowana z myślą o większej ilości języków).
                    ...
                    <div id="Modal2" class="modal fade" role="dialog">
                      <div class="modal-dialog modal-lg">         
                        <div class="modal-content"> 
                          ...
                          <div class="modal-body">
                              <p>Strona wizytówka utworzona dla znajomego elekronika, informująca o kursach dla młodzieży.
